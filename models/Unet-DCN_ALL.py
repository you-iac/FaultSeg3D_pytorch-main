...
class Up(nn.Module):
    def __init__(self, in_channels, out_channels, use_deformable=False):
        ...
        if use_deformable:
            # 使用 tvdcn.ops.PackedDeformConv3d 替换 nn.Conv3d
            self.double_conv = DoubleDeformConv(in_channels, out_channels, out_channels)
        else:
...
# ================================================================
# Total params: 1,612,486
# Trainable params: 1,612,486
# Non-trainable params: 0
# ----------------------------------------------------------------
# Input size (MB): 8.00
# Forward/backward pass size (MB): 8890.75
# Params size (MB): 6.15
# Estimated Total Size (MB): 8904.90
# ----------------------------------------------------------------
