...
def add_args():
    ...
    parser.add_argument("--exp", default="400_50_Unet_cldice", type=str, help="Name of each run")
    ...
    parser.add_argument("--loss_func", default="data_3D_400", choices=['dice', 'cross_with_weight','dice_plus_ce'], type=str, help="choose loss function")
