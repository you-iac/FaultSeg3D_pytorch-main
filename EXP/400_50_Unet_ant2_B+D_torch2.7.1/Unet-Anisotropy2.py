...
class FaultSeg3D(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.inc = DoubleConv(n_channels, 16, kernel_size=(7, 3, 3), padding=(3, 1, 1))

        # 第二层使用3x3x7卷积，padding为(1,1,3)保持空间尺寸不变
        self.down1 = Down(16, 32, kernel_size=(7, 3, 3), padding=(3, 1, 1))

        # 第三层使用3x3x5卷积，padding为(1,1,2)保持空间尺寸不变
        self.down2 = Down(32, 64, kernel_size=(5, 3, 3), padding=(2, 1, 1))

        # 第四层使用3x3x5卷积，padding为(1,1,2)保持空间尺寸不变
        self.down3 = Down(64, 128, kernel_size=(5, 3, 3), padding=(2, 1, 1))
